...
# USO DO SCRIPT:
# prompt$ ./classificador [-v] ClassificationAlgo main/resources/data/train main/resources/data/teste trainPercent emailSize
...
if [ "$#" -eq 6 ]; then
    # VERBOSE OPTION
        #java -cp "${HOME_FOLDER}/lib/*" ${MAIN_CLASS} -v NaiveBayes main/resources/data/train main/resources/data/teste trainPercent emailSize
        java -cp "${HOME_FOLDER}/lib/*" ${MAIN_CLASS} $1 $2 $3 $4 $5 $6
fi

if [ "$#" -eq 5 ]; then
        # NOT VERBOSE OPTION
        #java -cp "${HOME_FOLDER}/lib/*" ${MAIN_CLASS} NaiveBayes main/resources/data/train main/resources/data/teste trainPercent emailSize
        java -cp "${HOME_FOLDER}/lib/*" ${MAIN_CLASS} $1 $2 $3 $4 $5
fi
